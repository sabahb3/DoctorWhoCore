...
{
    public partial class SeedingEpisode : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, 1, 0, new DateTime(2005, 6, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, "Bonus", null, 1, "Be Better" },
                    { 4, 5, 3, new DateTime(2006, 6, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "Full", null, 2, "Warnning" },
                    { 5, 2, 0, new DateTime(2022, 4, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, "Bonus", null, 2, "Warnning" }
                });
        }
